      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Full-Stack & AI Engineer pursuing B.Tech in Computer Science and Engineering at IIIT Ranchi, passionate about building distributed real-time microservices, event-driven architectures, and stateful multi-agent GenAI systems.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4 p-4 rounded-xl bg-white dark:bg-slate-900 shadow-sm border border-gray-100 dark:border-slate-800">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">
                  Microservices, WebSockets, Redis Pub/Sub brokers with deduplication, and cache-aside patterns.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4 p-4 rounded-xl bg-white dark:bg-slate-900 shadow-sm border border-gray-100 dark:border-slate-800">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white">
                  Stateful GenAI & Agentic Workflows
                </h4>
                <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">
                  Multi-agent orchestration DAGs, hybrid RAG pipelines, sub-second STT/TTS voice streams, and vector search.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4 p-4 rounded-xl bg-white dark:bg-slate-900 shadow-sm border border-gray-100 dark:border-slate-800">
              <div className="w-4 h-4 mt-1 bg-emerald-500 rounded-full flex-shrink-0"></div>
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white">
                  Production Engineering & DevOps
                </h4>
                <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">
                  Docker containerization, automated GitHub Actions CI/CD pipelines, AWS Lightsail deployment, and telemetry.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {skillCategories.map((cat, index) => (
            <div
              key={index}
              className="group bg-white dark:bg-slate-900 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 flex flex-col justify-between"
            >
              <div>
                <div
